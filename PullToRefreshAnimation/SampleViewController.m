...
- (void)setupLoadingIndicator
{
    ...
    PocketSVG *myVectorDrawing = [[PocketSVG alloc] initFromSVGFileNamed:@"BezierCurve2"];    //BezierCurve1
    ...
    loadShape.path = myBezierPath.CGPath;//[self loadPath];
    
//    loadShape.strokeColor = [ios7BlueColor CGColor];
//    loadShape.lineWidth = 4;
//    loadShape.fillColor = [ios7BlueColor CGColor];
    ...
    for (CAShapeLayer *shape in @[loadShape, ingShape]) {
        shape.strokeColor = ios7BlueColor.CGColor;
